"""Bài Tập 4: Privacy Agent và conditional routing đã hoàn chỉnh."""
...
Hãy phân tích các vấn đề về GDPR, quyền riêng tư, bảo vệ dữ liệu và data breach.
Nêu rõ nghĩa vụ thông báo, quyền của chủ thể dữ liệu và chế tài có thể áp dụng."""
